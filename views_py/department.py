...
class Ui_departments(object):
    def setupUi(self, departments):
        ...
        self.on_search_department = QtWidgets.QPushButton(self.panel_add)
        self.on_search_department.setObjectName("on_search_department")
        self.verticalLayout_5.addWidget(self.on_search_department)
        ...
        self.list_departments.setColumnCount(6)
        ...
        self.list_departments.horizontalHeader().setDefaultSectionSize(100)
        self.list_departments.horizontalHeader().setStretchLastSection(True)
    ...
    def retranslateUi(self, departments):
        ...
        self.on_search_department.setText(_translate("departments", "Add"))
        ...
        item.setText(_translate("departments", "  "))
        item = self.list_departments.horizontalHeaderItem(5)
        item.setText(_translate("departments", " "))
